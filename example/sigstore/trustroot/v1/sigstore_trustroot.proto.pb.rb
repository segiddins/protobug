  ...
  module TrustRoot   
    module V1   
      ...
      class TransparencyLogInstance   
        ...
        optional(2, "hash_algorithm", type: :enum, enum_type: "dev.sigstore.common.v1.HashAlgorithm", json_name: "hashAlgorithm")
        ...
        optional(3, "public_key", type: :message, message_type: "dev.sigstore.common.v1.PublicKey", json_name: "publicKey")
      ...
      class CertificateAuthority   
        ...
        optional(3, "cert_chain", type: :message, message_type: "dev.sigstore.common.v1.X509CertificateChain", json_name: "certChain")
      ...
      class TrustedRoot   
        ...
        repeated(2, "tlogs", type: :message, message_type: "dev.sigstore.trustroot.v1.TransparencyLogInstance")
        ...
        # signatures.
        repeated(3, "certificate_authorities", type: :message, message_type: "dev.sigstore.trustroot.v1.CertificateAuthority", json_name: "certificateAuthorities")
        # A set of trusted certificate transparency logs.
        repeated(4, "ctlogs", type: :message, message_type: "dev.sigstore.trustroot.v1.TransparencyLogInstance")
