...
module Conformance
  ...
  class ConformanceRequest
    ...
    optional(7, "jspb_payload", type: :string, json_name: "jspbPayload", oneof: :payload)
    optional(8, "text_payload", type: :string, json_name: "textPayload", oneof: :payload)
    # Which format should the testee serialize its message to?
    optional(3, "requested_output_format", type: :enum, enum_type: "conformance.WireFormat", json_name: "requestedOutputFormat")
    ...
    optional(5, "test_category", type: :enum, enum_type: "conformance.TestCategory", json_name: "testCategory")
    # Specify details for how to encode jspb.
    optional(6, "jspb_encoding_options", type: :message, message_type: "conformance.JspbEncodingConfig", json_name: "jspbEncodingOptions")
  ...
  class ConformanceResponse
    ...
    optional(1, "parse_error", type: :string, json_name: "parseError", oneof: :result)
    # If the input was successfully parsed but errors occurred when
    # serializing it to the requested output format, set the error message in
    # this field.
    optional(6, "serialize_error", type: :string, json_name: "serializeError", oneof: :result)
    # This should be set if the test program timed out.  The string should
    # provide more information about what the child process was doing when it
    # was killed.
    optional(9, "timeout_error", type: :string, json_name: "timeoutError", oneof: :result)
    # This should be set if some other error occurred.  This will always
    # indicate that the test failed.  The string can provide more information
    # about the failure.
    optional(2, "runtime_error", type: :string, json_name: "runtimeError", oneof: :result)
    # If the input was successfully parsed and the requested output was
    # protobuf, serialize it to protobuf and set it in this field.
    optional(3, "protobuf_payload", type: :bytes, json_name: "protobufPayload", oneof: :result)
    # If the input was successfully parsed and the requested output was JSON,
    # serialize to JSON and set it in this field.
    optional(4, "json_payload", type: :string, json_name: "jsonPayload", oneof: :result)
    ...
    optional(7, "jspb_payload", type: :string, json_name: "jspbPayload", oneof: :result)
    # If the input was successfully parsed and the requested output was
