...
module Protobuf_test_messages
  module Proto2
    ...
    class TestAllTypesProto2
      ...
      optional(18, "optional_nested_message", type: :message, message_type: "protobuf_test_messages.proto2.TestAllTypesProto2.NestedMessage", json_name: "optionalNestedMessage")
      optional(19, "optional_foreign_message", type: :message, message_type: "protobuf_test_messages.proto2.ForeignMessageProto2", json_name: "optionalForeignMessage")
      optional(21, "optional_nested_enum", type: :enum, enum_type: "protobuf_test_messages.proto2.TestAllTypesProto2.NestedEnum", json_name: "optionalNestedEnum")
      optional(22, "optional_foreign_enum", type: :enum, enum_type: "protobuf_test_messages.proto2.ForeignEnumProto2", json_name: "optionalForeignEnum")
      ...
      optional(27, "recursive_message", type: :message, message_type: "protobuf_test_messages.proto2.TestAllTypesProto2", json_name: "recursiveMessage")
      # Repeated
      ...
      repeated(33, "repeated_uint32", type: :uint32, json_name: "repeatedUint32")
      repeated(34, "repeated_uint64", type: :uint64, json_name: "repeatedUint64")
      repeated(35, "repeated_sint32", type: :sint32, json_name: "repeatedSint32")
      repeated(36, "repeated_sint64", type: :sint64, json_name: "repeatedSint64")
      repeated(37, "repeated_fixed32", type: :fixed32, json_name: "repeatedFixed32")
      repeated(38, "repeated_fixed64", type: :fixed64, json_name: "repeatedFixed64")
      repeated(39, "repeated_sfixed32", type: :sfixed32, json_name: "repeatedSfixed32")
      repeated(40, "repeated_sfixed64", type: :sfixed64, json_name: "repeatedSfixed64")
      repeated(41, "repeated_float", type: :float, json_name: "repeatedFloat")
      repeated(42, "repeated_double", type: :double, json_name: "repeatedDouble")
      ...
      repeated(48, "repeated_nested_message", type: :message, message_type: "protobuf_test_messages.proto2.TestAllTypesProto2.NestedMessage", json_name: "repeatedNestedMessage")
      repeated(49, "repeated_foreign_message", type: :message, message_type: "protobuf_test_messages.proto2.ForeignMessageProto2", json_name: "repeatedForeignMessage")
      repeated(51, "repeated_nested_enum", type: :enum, enum_type: "protobuf_test_messages.proto2.TestAllTypesProto2.NestedEnum", json_name: "repeatedNestedEnum")
      repeated(52, "repeated_foreign_enum", type: :enum, enum_type: "protobuf_test_messages.proto2.ForeignEnumProto2", json_name: "repeatedForeignEnum")
      ...
      optional(247, "default_fixed32", type: :fixed32, json_name: "defaultFixed32")
      optional(248, "default_fixed64", type: :fixed64, json_name: "defaultFixed64")
      optional(249, "default_sfixed32", type: :sfixed32, json_name: "defaultSfixed32")
      optional(250, "default_sfixed64", type: :sfixed64, json_name: "defaultSfixed64")
      ...
      class MessageSetCorrectExtension1
        ...
        # extension: protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect message_set_extension 1547769
      ...
      class MessageSetCorrectExtension2
        ...
        # extension: protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect message_set_extension 4135312
    ...
    # extension: protobuf_test_messages.proto2.TestAllTypesProto2 extension_int32 120
    ...
    class TestAllRequiredTypesProto2
      ...
      required(7, "required_fixed32", type: :fixed32, json_name: "requiredFixed32")
      required(8, "required_fixed64", type: :fixed64, json_name: "requiredFixed64")
      required(9, "required_sfixed32", type: :sfixed32, json_name: "requiredSfixed32")
      required(10, "required_sfixed64", type: :sfixed64, json_name: "requiredSfixed64")
      required(11, "required_float", type: :float, json_name: "requiredFloat")
      required(12, "required_double", type: :double, json_name: "requiredDouble")
      required(13, "required_bool", type: :bool, json_name: "requiredBool")
      required(14, "required_string", type: :string, json_name: "requiredString")
      required(15, "required_bytes", type: :bytes, json_name: "requiredBytes")
      required(18, "required_nested_message", type: :message, message_type: "protobuf_test_messages.proto2.TestAllRequiredTypesProto2.NestedMessage", json_name: "requiredNestedMessage")
      required(19, "required_foreign_message", type: :message, message_type: "protobuf_test_messages.proto2.ForeignMessageProto2", json_name: "requiredForeignMessage")
      required(21, "required_nested_enum", type: :enum, enum_type: "protobuf_test_messages.proto2.TestAllRequiredTypesProto2.NestedEnum", json_name: "requiredNestedEnum")
      required(22, "required_foreign_enum", type: :enum, enum_type: "protobuf_test_messages.proto2.ForeignEnumProto2", json_name: "requiredForeignEnum")
      required(24, "required_string_piece", type: :string, json_name: "requiredStringPiece")
      ...
      required(247, "default_fixed32", type: :fixed32, json_name: "defaultFixed32")
      required(248, "default_fixed64", type: :fixed64, json_name: "defaultFixed64")
      required(249, "default_sfixed32", type: :sfixed32, json_name: "defaultSfixed32")
      required(250, "default_sfixed64", type: :sfixed64, json_name: "defaultSfixed64")
      ...
      class MessageSetCorrectExtension1
        ...
        # extension: protobuf_test_messages.proto2.TestAllRequiredTypesProto2.MessageSetCorrect message_set_extension 1547769
      ...
      class MessageSetCorrectExtension2
        ...
        # extension: protobuf_test_messages.proto2.TestAllRequiredTypesProto2.MessageSetCorrect message_set_extension 4135312
    ...
    def self.register_test_messages_proto2_protos(registry)
      ...
      # extension: protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect TYPE_MESSAGE 1547769
      registry.register(Protobuf_test_messages::Proto2::TestAllTypesProto2::MessageSetCorrectExtension2)
      # extension: protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect TYPE_MESSAGE 4135312
      ...
      registry.register(Protobuf_test_messages::Proto2::UnknownToTestAllTypes::OptionalGroup)
      registry.register(Protobuf_test_messages::Proto2::NullHypothesisProto2)
      registry.register(Protobuf_test_messages::Proto2::EnumOnlyProto2)
      registry.register(Protobuf_test_messages::Proto2::EnumOnlyProto2::Bool)
      registry.register(Protobuf_test_messages::Proto2::OneStringProto2)
      registry.register(Protobuf_test_messages::Proto2::ProtoWithKeywords)
      registry.register(Protobuf_test_messages::Proto2::TestAllRequiredTypesProto2)
      registry.register(Protobuf_test_messages::Proto2::TestAllRequiredTypesProto2::NestedMessage)
      ...
      # extension: protobuf_test_messages.proto2.TestAllRequiredTypesProto2.MessageSetCorrect TYPE_MESSAGE 1547769
      registry.register(Protobuf_test_messages::Proto2::TestAllRequiredTypesProto2::MessageSetCorrectExtension2)
      # extension: protobuf_test_messages.proto2.TestAllRequiredTypesProto2.MessageSetCorrect TYPE_MESSAGE 4135312
    end
  end
end
