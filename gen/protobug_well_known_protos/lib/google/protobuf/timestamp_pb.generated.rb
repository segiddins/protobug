class Google::Protobuf::Timestamp # /lib/google/protobuf/timestamp_pb.rb:140
  def initialize(
    seconds: nil,
    nanos: nil
  )
  ...
  if header == 0x8
    ...
    @seconds = (if (value & 0x8000_0000_0000_0000) != 0
  ...
  def as_json
    json = {}
    json["seconds"] = @seconds.to_s if has_seconds?
    json["nanos"] = @nanos if has_nanos?
    json
  end

  # optional(1, :seconds, type: :int64)
  def seconds=(value)
    raise Protobug::InvalidValueError.new(self, "seconds", value) unless value.is_a?(Integer)
    raise Protobug::InvalidValueError.new(self, "seconds", value, "does not fit into [-9223372036854775808, 9223372036854775807]") unless value <= 9223372036854775807 && value >= -9223372036854775808
    @seconds = value
  end
  def seconds
    value = @seconds
  ...
  # optional(2, :nanos, type: :int32)
  def nanos=(value)
    raise Protobug::InvalidValueError.new(self, "nanos", value) unless value.is_a?(Integer)
    raise Protobug::InvalidValueError.new(self, "nanos", value, "does not fit into [-2147483648, 2147483647]") unless value <= 2147483647 && value >= -2147483648
    @nanos = value
  end
  def nanos
    value = @nanos
